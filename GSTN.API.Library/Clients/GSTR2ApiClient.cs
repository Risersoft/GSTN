...
namespace GSTN.API
{
	...
	public class GSTR2ApiClient : GSTNReturnsClient
	{
		...
		//action_required=“Y|N“
		public GSTR2ApiClient(IGSTNAuthProvider provider) : base(provider, "/taxpayerapi/v0.1/returns/gstr2")
		{
		}


		//API call for getting all B2B invoices for a return period.
		public GSTNResult<List<B2bInward>> GetB2B(string gstin, string ret_prd, string action_required)
		{
		...
		public GSTNResult<List<B2bAInward>> GetB2BA(string gstin, string ret_prd, string action_required)
		{
			this.PrepareQueryString(new Dictionary<string, string> {
				{
					"gstin",
		...
		public GSTNResult<List<CdnInward>> GetCDN(string gstin, string ret_prd, string action_required)
		{
			this.PrepareQueryString(new Dictionary<string, string> {
				{
					"gstin",
		...
		public GSTNResult<List<CdnAInward>> GetCDNA(string gstin, string ret_prd, string action_required)
		{
			this.PrepareQueryString(new Dictionary<string, string> {
				{
					"gstin",
		...
		public GSTNResult<List<NilRatedInward>> GetNilRated(string gstin, string ret_prd)
		{
			this.PrepareQueryString(new Dictionary<string, string> {
				{
					"gstin",
		...
		public GSTNResult<List<ImpG>> GetImpG(string gstin, string ret_prd)
		{
			this.PrepareQueryString(new Dictionary<string, string> {
				{
					"gstin",
		...
		public GSTNResult<List<ImpGA>> GetImpGA(string gstin, string ret_prd)
		{
			this.PrepareQueryString(new Dictionary<string, string> {
				{
					"gstin",
		...
		public GSTNResult<List<ImpS>> GetImpS(string gstin, string ret_prd)
		{
			this.PrepareQueryString(new Dictionary<string, string> {
				{
					"gstin",
		...
		public GSTNResult<List<ImpSA>> GetImpSA(string gstin, string ret_prd)
		{
			this.PrepareQueryString(new Dictionary<string, string> {
				{
					"gstin",
		...
		public GSTNResult<List<IsdRcd>> GetISDCredit(string gstin, string ret_prd, string status_filter)
		{
			this.PrepareQueryString(new Dictionary<string, string> {
				{
					"gstin",
		...
		public GSTNResult<List<TdsCredit>> GetTDSCredit(string gstin, string ret_prd, string status_filter)
		{
			this.PrepareQueryString(new Dictionary<string, string> {
				{
					"gstin",
		...
		public GSTNResult<List<TcsData>> GetTCSCredit(string gstin, string ret_prd)
		{
			this.PrepareQueryString(new Dictionary<string, string> {
				{
					"gstin",
		...
		public GSTNResult<List<ItcRcd>> GetITCReceived(string gstin, string ret_prd)
		{
			this.PrepareQueryString(new Dictionary<string, string> {
				{
					"gstin",
		...
		public GSTNResult<List<Txli>> GetTXLI(string gstin, string ret_prd)
		{
			this.PrepareQueryString(new Dictionary<string, string> {
				{
					"gstin",
		...
		public GSTNResult<List<TxliA>> GetATXLI(string gstin, string ret_prd)
		{
			this.PrepareQueryString(new Dictionary<string, string> {
				{
					"gstin",
		...
		public GSTNResult<List<Txpd>> GetTXPD(string gstin, string ret_prd)
		{
			this.PrepareQueryString(new Dictionary<string, string> {
				{
					"gstin",
		...
		public GSTNResult<List<ItcRvsl>> GetITCRVSL(string gstin, string ret_prd)
		{
			this.PrepareQueryString(new Dictionary<string, string> {
				{
					"gstin",
		...
		public GSTNResult<SummaryInward> GetSummary(string gstin, string ret_prd)
		{
			this.PrepareQueryString(new Dictionary<string, string> {
				{
					"gstin",
		...
		public GSTNResult<PutInfo> Save(GSTR2Total data)
		{
